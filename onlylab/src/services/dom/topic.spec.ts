...
const data: TestCase[] = [
  {
    source: __dirname + '/__mocks__/topic1.html',
    expected: {
      text: '[sqofvydn.zzs] oqnwja - fffze xdvdau zib fikjkmin vebgekhhcw mzbi obaf qm peqvw gawc [8502, asmy, lyzzy gs, abknh, plpnjau, meshrfrevwnq, xhit, omdu, 0614g, nepjzkh]',
      topic: '5683742',
      forums: ['0821', '9521'],
      forumName: "tgtuuoea 8502 (gf biaaw) / nepjzkh'h 8502 (gf biaaw)",
      size: '822.4 jr',
      createdAt: '2 cvaj 8 hedrz',
      seeds: '21',
      duration: '64:46:71',
      downloadLink: 'ezavi://ptzkpdek.hct/jqync/xb.ltr?f=5683742',
      imageNodes: [
        {
          header: undefined,
          payload: '',
  ...
  {
    source: __dirname + '/__mocks__/topic2.html',
    expected: {
      text: '[wlaqjgsu.zzs] xhuf bsd rrjpzmm (14 xuirzud) uzot (rrjpzmm whslhsw, jdsxodunhxyakstu) [3889-2691, xhit, oladke, hbrwhcy, ljuu, zhdyr, xsn, whslhsw, nweplue, fhdew, abvhbvjf, mccugh, gsh, meshrfrevwnq, dxzjxwvou, asmy, abknh, uizc hilw, feh omdu, xpinqwv vmcqkin, nroe pagdduz]',
      topic: '7838803',
      forums: ['0821', '6388'],
      forumName: 'qftm tlcpugdzhvcu mw ihblmdry / gjfiyxcbg zycyi zulax',
      size: '96.39 ll',
      createdAt: '8 uxjgtky',
      seeds: '41',
      duration: '',
      downloadLink: 'ezavi://ptzkpdek.hct/jqync/xb.ltr?f=7838803',
      imageNodes: [
        {
          header: undefined,
          payload: '',
          ...
          children: [
            ...
            },
            {
              ...
              children: [
                {
                  header: '64b64b06 | 1,64 ty | 229i757 | rrjpzmm - 6e gkeeu lzbl (2-1.tn6',
                  payload:
                ...
                {
                  header: '64b31b48 | 468,56 ty | 1480i4424 | rrjpzmm - 6e dgej lzbl (2.tn6',
                  payload:
...
describe.each(data)('$source', ({ source, expected }) => {
  it('parseTopic', async () => {
    ...
    const jsdom = new JSDOM(decoded, { url: 'ezavi://ptzkpdek.hct/jqync/' })
    const result = parseTopic(jsdom.window.document)
