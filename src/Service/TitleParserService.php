...
use App\Service\Parser\Title\OriginalTitleParser;
...
class TitleParserService
{
    ...
    public function getOriginalTitle(string $title)
    {
        return $this->loader->getParser(OriginalTitleParser::class)->parse($title);
    }
}
