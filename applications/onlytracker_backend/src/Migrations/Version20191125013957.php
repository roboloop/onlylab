 ...
 */
final class Version20191125013957 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE forums (id VARCHAR(255) NOT NULL, ex_id INT NOT NULL, title VARCHAR(4095) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE images (id VARCHAR(255) NOT NULL, topic_id VARCHAR(255) NOT NULL, front_url VARCHAR(4095) NOT NULL, reference VARCHAR(4095) DEFAULT NULL, original VARCHAR(4095) DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', is_banner TINYINT(1) NOT NULL, format VARCHAR(30) NOT NULL, INDEX IDX_E01FBE6A1F55203D (topic_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE topics (id VARCHAR(255) NOT NULL, forum_id VARCHAR(255) DEFAULT NULL, ex_id INT NOT NULL, size INT DEFAULT NULL, ex_created_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', is_loaded TINYINT(1) NOT NULL, raw_title VARCHAR(4095) NOT NULL, title VARCHAR(4095) DEFAULT NULL, year VARCHAR(16) DEFAULT NULL, quality VARCHAR(16) DEFAULT NULL, INDEX IDX_91F6463929CCBAD0 (forum_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE genre_topic (topic_id VARCHAR(255) NOT NULL, genre_id VARCHAR(255) NOT NULL, INDEX IDX_2046C1DE1F55203D (topic_id), INDEX IDX_2046C1DE4296D31F (genre_id), PRIMARY KEY(topic_id, genre_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE studio_topic (topic_id VARCHAR(255) NOT NULL, studio_id VARCHAR(255) NOT NULL, INDEX IDX_63F53ED61F55203D (topic_id), INDEX IDX_63F53ED6446F285F (studio_id), PRIMARY KEY(topic_id, studio_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
